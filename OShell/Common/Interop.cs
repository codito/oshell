...
namespace OShell.Common
{
    ...
    public static class Interop
    {
        ...
        #region Keyboard
        internal static bool RegisterHotKey(IntPtr handle, Keys key, int keyId)
        {
            int modifiers = 0;
            ...
            return RegisterHotKeyInternal(handle, keyId, (uint)modifiers, (uint)k);
        }

        internal static bool UnregisterHotKey(IntPtr handle, int keyId)
        {
            return UnregisterHotKeyInternal(handle, keyId);
        }
